...
(function () {
  ...
  function addHomepageMultimediaTeaser() {
    ...
    var teaser = el(
      ...
      '    <div>' +
      '      <div style="font-size:11px;letter-spacing:4px;text-transform:uppercase;color:#cbdba0;font-weight:700;margin-bottom:14px;">— LONGFORM —</div>' +
      '      <h2 style="font-family:\'Playfair Display\',serif;font-size:44px;font-weight:800;line-height:1.1;margin:0 0 18px;letter-spacing:0.3px;">Ở lại hay rời đi <br/><em style="font-style:italic;color:#cbdba0;"> Ngã rẽ nào cho người miền Tây </em></h2>' +
      '      <p style="font-family:\'Lora\',serif;font-size:17px;line-height:1.7;color:rgba(255,255,255,0.92);margin:0 0 26px;"> Làn sóng di cư của người miên Tây trước biến đổi khí hậu.</p>' +
      '      <a href="multimedia/multimedia.html" style="display:inline-flex;align-items:center;gap:12px;padding:14px 28px;background:#fff;color:#31511E;text-decoration:none;font-weight:700;font-size:13px;letter-spacing:2px;text-transform:uppercase;border-radius:3px;transition:transform 0.3s;">Xem tại đây <span>→</span></a>' +
      '    </div>' +
      '    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">' +
      '      <a href="multimedia/chuong1.html" style="aspect-ratio:1;background:url(\'multimedia/images/chương 1.webp\') center/cover;border-radius:4px;position:relative;overflow:hidden;text-decoration:none;"><span style="position:absolute;inset:0;background:linear-gradient(180deg,transparent 50%,rgba(20,30,15,0.9));display:flex;align-items:flex-end;padding:12px;color:#fff;font-family:\'Playfair Display\',serif;font-size:14px;font-weight:700;">01 · Đất - Khởi nguồn của sự sống </span></a>' +
      '      <a href="multimedia/chuong2.html" style="aspect-ratio:1;background:url(\'multimedia/images/chuong2-ruong.jpg\') center/cover;border-radius:4px;position:relative;overflow:hidden;text-decoration:none;"><span style="position:absolute;inset:0;background:linear-gradient(180deg,transparent 50%,rgba(20,30,15,0.9));display:flex;align-items:flex-end;padding:12px;color:#fff;font-family:\'Playfair Display\',serif;font-size:14px;font-weight:700;">02 · Khi ruộng đồng không còn <br> nuôi nổi người miền Tây </span></a>' +
      '      <a href="multimedia/chuong3.html" style="aspect-ratio:1;background:url(\'multimedia/images/chương 3.jpg\') center/cover;border-radius:4px;position:relative;overflow:hidden;text-decoration:none;"><span style="position:absolute;inset:0;background:linear-gradient(180deg,transparent 50%,rgba(20,30,15,0.9));display:flex;align-items:flex-end;padding:12px;color:#fff;font-family:\'Playfair Display\',serif;font-size:14px;font-weight:700;">03 · Ba cú đánh vào sinh kế miền Tây </span></a>' +
      '      <a href="multimedia/chuong4.html" style="aspect-ratio:1;background:url(\'multimedia/images/chương 4.jpg\') center/cover;border-radius:4px;position:relative;overflow:hidden;text-decoration:none;"><span style="position:absolute;inset:0;background:linear-gradient(180deg,transparent 50%,rgba(20,30,15,0.9));display:flex;align-items:flex-end;padding:12px;color:#fff;font-family:\'Playfair Display\',serif;font-size:14px;font-weight:700;">04 · Ở lại hay rời đi: <br> Những lựa chọn không hề dễ dàng </span></a>' +
      '    </div>' +
      '  </div>' +
      '</section>'
    );
